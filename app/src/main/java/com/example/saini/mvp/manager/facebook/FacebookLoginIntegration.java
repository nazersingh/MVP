package com.example.saini.mvp.manager.facebook;
...
public class FacebookLoginIntegration {
     ...
     */
    public static void callFacebookLogin(final Activity activity, final CallbackManager callbackManager, final GenericCallBack genricCallback) {
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onError(FacebookException exception) {
                        ...
                        faceBookLogout();
                        genricCallback.onFail(exception);
                    }
                });
    }
     ...
     */
    public static void RequestData(AccessToken currentAccessToken, final GenericCallBack genricCallback) {
        ...
        GraphRequest request = GraphRequest.newMeRequest(currentAccessToken, new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                ...
                try {
                    ...
                    genricCallback.onSuccessListener(json);
     ...
     * @param genricCallback
     */
    public static void shareOnFaceBook(Activity activity,CallbackManager callbackManager,GenericCallBack genricCallback)
    {
