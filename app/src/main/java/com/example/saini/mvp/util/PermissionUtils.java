   ...
   private Activity current_activity;
    ...
    public void check_permission(ArrayList<String> permissions, String dialog_content, int request_code)
    {
        ...
        if(Build.VERSION.SDK_INT >= 23)
        {
            ...
            {
                PrintLog.i("all permissions", "granted");
                PrintLog.i("proceed", "to callback");
                ...
                if(grantResults.length>0)
                {
                    ...
                    for (int i = 0; i < listPermissionsNeeded.size(); i++)
                    {
                        if (perms.get(listPermissionsNeeded.get(i)) != PackageManager.PERMISSION_GRANTED)
                        {
                            ...
                            {
                                PrintLog.i("Go to settings","and enable permissions");
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        switch (which) {
                                            ...
                                            case DialogInterface.BUTTON_NEGATIVE:
                                                PrintLog.i("permisson","not fully given");
                    ...
                    {
                        PrintLog.i("all","permissions granted");
                        PrintLog.i("proceed","to next step");
